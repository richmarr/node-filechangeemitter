/*!
 * DirWatcher - Watches a filesystem and emits events when changes occur. Adapted from the Cluster restart module
 *
...
var DirWatcher = exports.DirWatcher = function(files, options){
...
DirWatcher.prototype = new EventEmitter();
